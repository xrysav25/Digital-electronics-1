...
begin
    ...
    begin
        ...
        s_dp_i  <= "0111";
        wait for 15ns;
        assert (s_seg = "0000110") and (s_dig = "0111") and (s_dp_o = '0') report "Test failed for digit: 3" severity error;
        wait for 10ns;
        assert (s_seg = "1001111") and (s_dig = "1011") and (s_dp_o = '1') report "Test failed for digit: 1" severity error;
        wait for 10ns;
        assert (s_seg = "1101100") and (s_dig = "1101") and (s_dp_o = '1') report "Test failed for digit: 4" severity error;
        wait for 10ns;
        assert (s_seg = "0010010") and (s_dig = "1110") and (s_dp_o = '1') report "Test failed for digit: 2" severity error;
        wait;
